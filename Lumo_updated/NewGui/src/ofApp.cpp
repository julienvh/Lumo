...
void ofApp::buildGUI() {
	...
	Tx.set("Target X", 345, 200, 675);
	Ty.set("Target y", 647, 330, 700);
	mRotation.set("Rotation Motor", 0, -180, 180);
	...
	gui->addFRM();
	//gui->addValuePlotter("Search Freq.", 45, 135);
	//gui->addMatrix("Sounds", 21, true);
	gui->addBreak()->setHeight(20.0f);
	gui->add2dPad("2D Target", bounds);
	gui->addBreak()->setHeight(20.0f);
